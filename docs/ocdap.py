...
===========================================================
Products:
  1. Vanilla Options      — Black-76, full Greeks
  2. Asian Options        — Monte Carlo arithmetic/geometric
  3. Crack Spread Options — Kirk (1995) approximation
  4. Calendar Spread Opt. — Kirk on term structure
  5. Commodity Swaps      — Fixed-float NPV, break-even, DV01

Run:  streamlit run ocdap.py"""
...
# ── OCDAP supplement: vol + convenience per commodity ─────────────────────────
OPCAP_PARAMS = {
...
def run_streamlit_app():
    ...
    st.set_page_config(
        page_title="OCDAP — Commodity Derivatives Pricer",
    ...
    st.markdown(
        ...
        '-webkit-background-clip:text;-webkit-text-fill-color:transparent">OCDAP</h1>'
        '<span style="font-size:0.95rem;color:#6E7681;font-weight:600">'
        'Options &amp; Commodity Derivatives Analytics Platform</span>'
        '</div>'
    ...
    with st.sidebar:
        st.markdown(
            ...
            '-webkit-background-clip:text;-webkit-text-fill-color:transparent">OCDAP</div>'
    ...
    st.markdown("---")
    st.caption(f"OCDAP · Options & Commodity Derivatives Analytics Platform · "
